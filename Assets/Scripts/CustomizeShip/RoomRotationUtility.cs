...
public static class RoomRotationUtility
{
    ...
    /// <returns></returns>
    public static Vector2Int GetRotatedSize(Vector2Int originalSize, Constants.Rotations.Rotation rotation)
    {
        if (rotation == Constants.Rotations.Rotation.Rotation0 || rotation == Constants.Rotations.Rotation.Rotation180)
            return originalSize;
    ...
    /// <returns></returns>
    public static Vector2 GetRotationOffset(Vector2Int size, Constants.Rotations.Rotation rotation)
    {
        Vector2 baseOffset;
        ...
        if (size.x % 2 == 0 || size.y % 2 == 0)
        {
            ...
            {
                if (rotation == Constants.Rotations.Rotation.Rotation90)
                    baseOffset -= new Vector2(0.5f, 0.5f);
                else if (rotation == Constants.Rotations.Rotation.Rotation270)
                    baseOffset += new Vector2(0.5f, 0.5f);
            }
            else
            {
    ...
    public static List<Vector2Int> GetOccupiedGridPositions(Vector2Int origin, Vector2Int size,
        Constants.Rotations.Rotation rot)
    {
    ...
    /// <returns></returns>
    public static Vector2Int RotateDoorPos(Vector2Int localDoorPos, Constants.Rotations.Rotation rotation)
    {
        return rotation switch
        {
            Constants.Rotations.Rotation.Rotation0 => localDoorPos,
            Constants.Rotations.Rotation.Rotation90 => new Vector2Int(localDoorPos.y, -localDoorPos.x),
            Constants.Rotations.Rotation.Rotation180 => new Vector2Int(-localDoorPos.x, -localDoorPos.y),
            Constants.Rotations.Rotation.Rotation270 => new Vector2Int(-localDoorPos.y, localDoorPos.x),
            _ => localDoorPos
        };
    }
    ...
    /// <param name="rotation"></param>
    /// <returns></returns>
    public static DoorDirection RotateDoorDirection(DoorDirection original, Constants.Rotations.Rotation rotation)
    {
