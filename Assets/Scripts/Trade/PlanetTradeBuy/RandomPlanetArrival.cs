...
public class RandomPlanetArrival : MonoBehaviour
{
    ...
    /// </summary>
    [Tooltip("Resources 폴더 내부의 PlanetTradeData 에셋 경로 (예: ScriptableObject/Trade/PlanetInfo)")] [SerializeField]
    private string planetDataPath = "ScriptableObject/Trade/PlanetInfo";

    /// <summary>
    /// 현재 행성의 판매 데이터를 설정할 TradeManager의 참조입니다.
    /// </summary>
    [Tooltip("현재 행성 판매 데이터를 설정할 TradeManager 참조")] [SerializeField]
