...
namespace ES3Types
{
    ...
    public class ES3UserType_EngineRoom : ES3ComponentType
    {
        ...
        public ES3UserType_EngineRoom() : base(typeof(EngineRoom))
        {
            Instance = this;
            priority = 1;
        }
        ...
        {
            EngineRoom instance = (EngineRoom)obj;
            ...
            foreach (string propertyName in reader.Properties)
                switch (propertyName)
                {
                    case "currentRoomLevelData":
                        instance = (EngineRoom)reader.SetPrivateField("currentRoomLevelData",
                            reader.Read<EngineRoomData.EngineRoomLevel>(), instance);
                        break;
                    case "position":
                        instance.position = reader.Read<Vector2Int>(ES3Type_Vector2Int.Instance);
                        break;
                    case "currentLevel":
                        instance = (EngineRoom)reader.SetPrivateField("currentLevel", reader.Read<int>(), instance);
                        break;
                    ...
                    case "roomType":
                        ...
                        break;
                    case "isDamageable":
                        instance = (EngineRoom)reader.SetPrivateField("isDamageable", reader.Read<bool>(), instance);
                        break;
                    case "connectedDoors":
                        instance = (EngineRoom)reader.SetPrivateField("connectedDoors",
                    ...
                    case "isActive":
                        ...
                        break;
                    case "isPowered":
                        instance = (EngineRoom)reader.SetPrivateField("isPowered", reader.Read<bool>(), instance);
                        break;
                    case "isPowerRequested":
                        instance = (EngineRoom)reader.SetPrivateField("isPowerRequested", reader.Read<bool>(),
                            instance);
                        break;
                    case "parentShip":
                        ...
                        break;
                    case "gridSize":
                        instance = (EngineRoom)reader.SetPrivateField("gridSize", reader.Read<Vector2Int>(), instance);
                        break;
