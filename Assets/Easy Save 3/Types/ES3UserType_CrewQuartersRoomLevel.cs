...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("maxCrewCapacity", "crewMoraleBonus", "roomName", "level", "roomType", "category", "hitPoint", "size", "cost", "crewRequirement", "powerRequirement", "damageHitPointRate", "roomSprite", "roomIconPrefab", "toolTipPrefab", "possibleDoorPositions", "crewEntryGridPriority")]
	public class ES3UserType_CrewQuartersRoomLevel : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_CrewQuartersRoomLevel() : base(typeof(CrewQuartersRoomData.CrewQuartersRoomLevel)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (CrewQuartersRoomData.CrewQuartersRoomLevel)obj;
			
			writer.WriteProperty("maxCrewCapacity", instance.maxCrewCapacity, ES3Type_int.Instance);
			writer.WriteProperty("crewMoraleBonus", instance.crewMoraleBonus, ES3Type_int.Instance);
		...
		protected override void ReadObject<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "maxCrewCapacity":
						instance.maxCrewCapacity = reader.Read<System.Int32>(ES3Type_int.Instance);
						break;
					case "crewMoraleBonus":
						instance.crewMoraleBonus = reader.Read<System.Int32>(ES3Type_int.Instance);
						break;
					case "roomName":
		...
		{
			var instance = new CrewQuartersRoomData.CrewQuartersRoomLevel();
	...
	public class ES3UserType_CrewQuartersRoomLevelArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_CrewQuartersRoomLevelArray() : base(typeof(CrewQuartersRoomData.CrewQuartersRoomLevel[]), ES3UserType_CrewQuartersRoomLevel.Instance)
		{
			Instance = this;
		}
	}
