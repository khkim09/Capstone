			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "currentRotation":
						...
						break;
					case "isActive":
					instance = (ShieldRoom)reader.SetPrivateField("isActive", reader.Read<System.Boolean>(), instance);
					break;
					case "isPowered":
					...
					break;
					case "parentShip":
					instance = (ShieldRoom)reader.SetPrivateField("parentShip", reader.Read<Ship>(), instance);
					break;
					case "gridSize":
					instance = (ShieldRoom)reader.SetPrivateField("gridSize", reader.Read<UnityEngine.Vector2Int>(), instance);
					break;
					case "roomData":
						instance.roomData = reader.Read<ShieldRoomData>();
						break;
					default:
						reader.Skip();
						break;
