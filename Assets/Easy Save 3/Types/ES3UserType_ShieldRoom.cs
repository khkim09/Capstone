...
namespace ES3Types
{
	...
	public class ES3UserType_ShieldRoom : ES3ComponentType
	{
		public static ES3Type Instance = null;

		public ES3UserType_ShieldRoom() : base(typeof(ShieldRoom)){ Instance = this; priority = 1;}


		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			var instance = (ShieldRoom)obj;
		...
		protected override void ReadComponent<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					instance = (ShieldRoom)reader.SetPrivateField("currentRoomLevelData", reader.Read<ShieldRoomData.ShieldRoomLevel>(), instance);
					break;
					case "roomData":
					instance = (ShieldRoom)reader.SetPrivateField("roomData", reader.Read<RoomData>(), instance);
					break;
					case "position":
						instance.position = reader.Read<UnityEngine.Vector2Int>(ES3Type_Vector2Int.Instance);
						break;
					case "currentLevel":
					instance = (ShieldRoom)reader.SetPrivateField("currentLevel", reader.Read<System.Int32>(), instance);
					break;
					...
					case "roomType":
						...
						break;
					case "isDamageable":
					instance = (ShieldRoom)reader.SetPrivateField("isDamageable", reader.Read<System.Boolean>(), instance);
					break;
					case "connectedDoors":
					instance = (ShieldRoom)reader.SetPrivateField("connectedDoors", reader.Read<System.Collections.Generic.List<Door>>(), instance);
					break;
					...
					case "isActive":
						...
						break;
					case "isPowered":
					instance = (ShieldRoom)reader.SetPrivateField("isPowered", reader.Read<System.Boolean>(), instance);
					break;
					case "isPowerRequested":
					instance = (ShieldRoom)reader.SetPrivateField("isPowerRequested", reader.Read<System.Boolean>(), instance);
					break;
					case "roomRenderer":
					instance = (ShieldRoom)reader.SetPrivateField("roomRenderer", reader.Read<UnityEngine.SpriteRenderer>(), instance);
					break;
					case "parentShip":
						instance.parentShip = reader.Read<Ship>(ES3UserType_Ship.Instance);
						break;
					case "icon":
					instance = (ShieldRoom)reader.SetPrivateField("icon", reader.Read<UnityEngine.SpriteRenderer>(), instance);
					break;
					case "gridSize":
					instance = (ShieldRoom)reader.SetPrivateField("gridSize", reader.Read<UnityEngine.Vector2Int>(), instance);
					break;
	...
	public class ES3UserType_ShieldRoomArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_ShieldRoomArray() : base(typeof(ShieldRoom[]), ES3UserType_ShieldRoom.Instance)
		{
			Instance = this;
		}
	}
