...
namespace ES3Types
{
    ...
    public class ES3UserType_AmmunitionRoom : ES3ComponentType
    {
        ...
        public ES3UserType_AmmunitionRoom() : base(typeof(AmmunitionRoom))
        {
            Instance = this;
            priority = 1;
        }
        ...
        {
            AmmunitionRoom instance = (AmmunitionRoom)obj;
            ...
            foreach (string propertyName in reader.Properties)
                switch (propertyName)
                {
                    case "currentRoomLevelData":
                        instance = (AmmunitionRoom)reader.SetPrivateField("currentRoomLevelData",
                            reader.Read<AmmunitionRoomData.AmmunitionRoomLevel>(), instance);
                        break;
                    case "position":
                        instance.position = reader.Read<Vector2Int>(ES3Type_Vector2Int.Instance);
                        break;
                    case "currentLevel":
                        instance = (AmmunitionRoom)reader.SetPrivateField("currentLevel", reader.Read<int>(), instance);
                        break;
                    ...
                    case "roomType":
                        ...
                        break;
                    case "isDamageable":
                        instance = (AmmunitionRoom)reader.SetPrivateField("isDamageable", reader.Read<bool>(),
                            instance);
                        break;
                    case "connectedDoors":
                        instance = (AmmunitionRoom)reader.SetPrivateField("connectedDoors",
                    ...
                    case "isActive":
                        ...
                        break;
                    case "isPowered":
                        instance = (AmmunitionRoom)reader.SetPrivateField("isPowered", reader.Read<bool>(), instance);
                        break;
                    case "isPowerRequested":
                        instance = (AmmunitionRoom)reader.SetPrivateField("isPowerRequested", reader.Read<bool>(),
                            instance);
                        break;
                    case "parentShip":
                        ...
                        break;
                    case "gridSize":
                        instance = (AmmunitionRoom)reader.SetPrivateField("gridSize", reader.Read<Vector2Int>(),
                            instance);
                        break;
