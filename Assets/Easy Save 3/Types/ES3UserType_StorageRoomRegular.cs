...
namespace ES3Types
{
    ...
    public class ES3UserType_StorageRoomRegular : ES3ComponentType
    {
        ...
        public ES3UserType_StorageRoomRegular() : base(typeof(StorageRoomRegular))
        {
            Instance = this;
            priority = 1;
        }
        ...
        {
            StorageRoomRegular instance = (StorageRoomRegular)obj;
            ...
            foreach (string propertyName in reader.Properties)
                switch (propertyName)
                {
                    case "storedItems":
                        ...
                        break;
                    case "itemGrid":
                        instance = (StorageRoomRegular)reader.SetPrivateField("itemGrid", reader.Read<TradingItem[,]>(),
                            instance);
                        break;
                    case "currentRoomLevelData":
                        instance = (StorageRoomRegular)reader.SetPrivateField("currentRoomLevelData",
                    ...
                    case "position":
                        ...
                        break;
                    case "currentLevel":
                        instance = (StorageRoomRegular)reader.SetPrivateField("currentLevel", reader.Read<int>(),
                            instance);
                        break;
                    ...
                    case "roomType":
                        ...
                        break;
                    case "isDamageable":
                        instance = (StorageRoomRegular)reader.SetPrivateField("isDamageable", reader.Read<bool>(),
                            instance);
                        break;
                    case "connectedDoors":
                        instance = (StorageRoomRegular)reader.SetPrivateField("connectedDoors",
                    ...
                    case "isActive":
                        ...
                        break;
                    case "isPowered":
                        instance = (StorageRoomRegular)reader.SetPrivateField("isPowered", reader.Read<bool>(),
                            instance);
                        break;
                    case "isPowerRequested":
                        instance = (StorageRoomRegular)reader.SetPrivateField("isPowerRequested", reader.Read<bool>(),
                            instance);
                        break;
                    case "parentShip":
                        ...
                        break;
                    case "gridSize":
                        instance = (StorageRoomRegular)reader.SetPrivateField("gridSize", reader.Read<Vector2Int>(),
                            instance);
                        break;
    ...
    public class ES3UserType_StorageRoomRegularArray : ES3ArrayType
    {
        ...
        public ES3UserType_StorageRoomRegularArray() : base(typeof(StorageRoomRegular[]),
            ES3UserType_StorageRoomRegular.Instance)
        {
            Instance = this;
        }
    }
