...
namespace ES3Types
{
	...
	public class ES3UserType_LifeSupportRoom : ES3ComponentType
	{
		public static ES3Type Instance = null;

		public ES3UserType_LifeSupportRoom() : base(typeof(LifeSupportRoom)){ Instance = this; priority = 1;}


		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			var instance = (LifeSupportRoom)obj;
		...
		protected override void ReadComponent<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					instance = (LifeSupportRoom)reader.SetPrivateField("currentRoomLevelData", reader.Read<LifeSupportRoomData.LifeSupportRoomLevel>(), instance);
					break;
					case "roomData":
					instance = (LifeSupportRoom)reader.SetPrivateField("roomData", reader.Read<RoomData>(), instance);
					break;
					case "position":
						instance.position = reader.Read<UnityEngine.Vector2Int>(ES3Type_Vector2Int.Instance);
						break;
					case "currentLevel":
					instance = (LifeSupportRoom)reader.SetPrivateField("currentLevel", reader.Read<System.Int32>(), instance);
					break;
					...
					case "roomType":
						...
						break;
					case "isDamageable":
					instance = (LifeSupportRoom)reader.SetPrivateField("isDamageable", reader.Read<System.Boolean>(), instance);
					break;
					case "connectedDoors":
					instance = (LifeSupportRoom)reader.SetPrivateField("connectedDoors", reader.Read<System.Collections.Generic.List<Door>>(), instance);
					break;
					...
					case "isActive":
						...
						break;
					case "isPowered":
					instance = (LifeSupportRoom)reader.SetPrivateField("isPowered", reader.Read<System.Boolean>(), instance);
					break;
					case "isPowerRequested":
					instance = (LifeSupportRoom)reader.SetPrivateField("isPowerRequested", reader.Read<System.Boolean>(), instance);
					break;
					case "roomRenderer":
					instance = (LifeSupportRoom)reader.SetPrivateField("roomRenderer", reader.Read<UnityEngine.SpriteRenderer>(), instance);
					break;
					case "parentShip":
						instance.parentShip = reader.Read<Ship>(ES3UserType_Ship.Instance);
						break;
					case "icon":
					instance = (LifeSupportRoom)reader.SetPrivateField("icon", reader.Read<UnityEngine.SpriteRenderer>(), instance);
					break;
					case "gridSize":
					instance = (LifeSupportRoom)reader.SetPrivateField("gridSize", reader.Read<UnityEngine.Vector2Int>(), instance);
					break;
	...
	public class ES3UserType_LifeSupportRoomArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_LifeSupportRoomArray() : base(typeof(LifeSupportRoom[]), ES3UserType_LifeSupportRoom.Instance)
		{
			Instance = this;
		}
	}
