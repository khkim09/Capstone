...
namespace ES3Types
{
    ...
    public class ES3UserType_LifeSupportRoom : ES3ComponentType
    {
        ...
        public ES3UserType_LifeSupportRoom() : base(typeof(LifeSupportRoom))
        {
            Instance = this;
            priority = 1;
        }
        ...
        {
            LifeSupportRoom instance = (LifeSupportRoom)obj;
            ...
            foreach (string propertyName in reader.Properties)
                switch (propertyName)
                {
                    case "currentRoomLevelData":
                        instance = (LifeSupportRoom)reader.SetPrivateField("currentRoomLevelData",
                            reader.Read<LifeSupportRoomData.LifeSupportRoomLevel>(), instance);
                        break;
                    case "position":
                        instance.position = reader.Read<Vector2Int>(ES3Type_Vector2Int.Instance);
                        break;
                    case "currentLevel":
                        instance = (LifeSupportRoom)reader.SetPrivateField("currentLevel", reader.Read<int>(),
                            instance);
                        break;
                    ...
                    case "roomType":
                        ...
                        break;
                    case "isDamageable":
                        instance = (LifeSupportRoom)reader.SetPrivateField("isDamageable", reader.Read<bool>(),
                            instance);
                        break;
                    case "connectedDoors":
                        instance = (LifeSupportRoom)reader.SetPrivateField("connectedDoors",
                    ...
                    case "isActive":
                        ...
                        break;
                    case "isPowered":
                        instance = (LifeSupportRoom)reader.SetPrivateField("isPowered", reader.Read<bool>(), instance);
                        break;
                    case "isPowerRequested":
                        instance = (LifeSupportRoom)reader.SetPrivateField("isPowerRequested", reader.Read<bool>(),
                            instance);
                        break;
                    case "parentShip":
                        ...
                        break;
                    case "gridSize":
                        instance = (LifeSupportRoom)reader.SetPrivateField("gridSize", reader.Read<Vector2Int>(),
                            instance);
                        break;
    ...
    public class ES3UserType_LifeSupportRoomArray : ES3ArrayType
    {
        ...
        public ES3UserType_LifeSupportRoomArray() : base(typeof(LifeSupportRoom[]),
            ES3UserType_LifeSupportRoom.Instance)
        {
            Instance = this;
        }
    }
