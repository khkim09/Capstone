...
namespace ES3Types
{
    ...
    [ES3PropertiesAttribute("isPersonalRoom", "currentRoomLevelData", "position", "currentLevel", "currentHitPoints",
        "roomType", "isDamageable", "connectedDoors", "currentRotation", "crewInRoom", "isActive", "isPowered",
        "isPowerRequested", "parentShip", "gridSize", "damageCondition", "roomData")]
    public class ES3UserType_CrewQuartersRoom : ES3ComponentType
    {
        public static ES3Type Instance = null;

        public ES3UserType_CrewQuartersRoom() : base(typeof(CrewQuartersRoom))
        {
            Instance = this;
            priority = 1;
        }
        ...
        {
            CrewQuartersRoom instance = (CrewQuartersRoom)obj;
        ...
        protected override void ReadComponent<T>(ES3Reader reader, object obj)
        {
            ...
            foreach (string propertyName in reader.Properties)
                ...
                {
                    case "isPersonalRoom":
                        instance.isPersonalRoom = reader.Read<bool>(ES3Type_bool.Instance);
                        break;
                    case "currentRoomLevelData":
                        instance = (CrewQuartersRoom)reader.SetPrivateField("currentRoomLevelData",
                            reader.Read<CrewQuartersRoomData.CrewQuartersRoomLevel>(), instance);
                        break;
                    case "position":
                        instance.position = reader.Read<Vector2Int>(ES3Type_Vector2Int.Instance);
                        break;
                    case "currentLevel":
                        instance = (CrewQuartersRoom)reader.SetPrivateField("currentLevel", reader.Read<int>(),
                            instance);
                        break;
                    ...
                    case "roomType":
                        ...
                        break;
                    case "isDamageable":
                        instance = (CrewQuartersRoom)reader.SetPrivateField("isDamageable", reader.Read<bool>(),
                            instance);
                        break;
                    case "connectedDoors":
                        instance = (CrewQuartersRoom)reader.SetPrivateField("connectedDoors",
                    ...
                    case "isActive":
                        ...
                        break;
                    case "isPowered":
                        instance = (CrewQuartersRoom)reader.SetPrivateField("isPowered", reader.Read<bool>(), instance);
                        break;
                    case "isPowerRequested":
                        instance = (CrewQuartersRoom)reader.SetPrivateField("isPowerRequested", reader.Read<bool>(),
                            instance);
                        break;
                    case "parentShip":
                        ...
                        break;
                    case "gridSize":
                        instance = (CrewQuartersRoom)reader.SetPrivateField("gridSize", reader.Read<Vector2Int>(),
                            instance);
                        break;
    ...
    public class ES3UserType_CrewQuartersRoomArray : ES3ArrayType
    {
        ...
        public ES3UserType_CrewQuartersRoomArray() : base(typeof(CrewQuartersRoom[]),
            ES3UserType_CrewQuartersRoom.Instance)
        {
            Instance = this;
        }
    }
