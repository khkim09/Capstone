...
namespace ES3Types
{
    ...
    public class ES3UserType_TeleportRoom : ES3ComponentType
    {
        ...
        public ES3UserType_TeleportRoom() : base(typeof(TeleportRoom))
        {
            Instance = this;
            priority = 1;
        }
        ...
        {
            TeleportRoom instance = (TeleportRoom)obj;
            ...
            foreach (string propertyName in reader.Properties)
                switch (propertyName)
                {
                    case "currentRoomLevelData":
                        instance = (TeleportRoom)reader.SetPrivateField("currentRoomLevelData",
                            reader.Read<TeleportRoomData.TeleportRoomLevel>(), instance);
                        break;
                    case "position":
                        instance.position = reader.Read<Vector2Int>(ES3Type_Vector2Int.Instance);
                        break;
                    case "currentLevel":
                        instance = (TeleportRoom)reader.SetPrivateField("currentLevel", reader.Read<int>(), instance);
                        break;
                    ...
                    case "roomType":
                        ...
                        break;
                    case "isDamageable":
                        instance = (TeleportRoom)reader.SetPrivateField("isDamageable", reader.Read<bool>(), instance);
                        break;
                    case "connectedDoors":
                        instance = (TeleportRoom)reader.SetPrivateField("connectedDoors",
                    ...
                    case "isActive":
                        ...
                        break;
                    case "isPowered":
                        instance = (TeleportRoom)reader.SetPrivateField("isPowered", reader.Read<bool>(), instance);
                        break;
                    case "isPowerRequested":
                        instance = (TeleportRoom)reader.SetPrivateField("isPowerRequested", reader.Read<bool>(),
                            instance);
                        break;
                    case "parentShip":
                        ...
                        break;
                    case "gridSize":
                        instance = (TeleportRoom)reader.SetPrivateField("gridSize", reader.Read<Vector2Int>(),
                            instance);
                        break;
