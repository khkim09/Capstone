...
namespace ES3Types
{
	...
	public class ES3UserType_Ship : ES3ComponentType
	{
		...
		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			...
			writer.WriteProperty("backupRooms", instance.backupRooms, ES3Internal.ES3TypeMgr.GetOrCreateES3Type(typeof(System.Collections.Generic.List<Room>)));
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "testRoomPrefab3":
						...
						break;
					case "backupRooms":
						instance.backupRooms = reader.Read<System.Collections.Generic.List<Room>>();
						break;
