...
namespace ES3Types
{
	...
	public class ES3UserType_RoomLevel : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_RoomLevel() : base(typeof(RoomData.RoomLevel)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (RoomData.RoomLevel)obj;
		...
		{
			var instance = new RoomData.RoomLevel();
	...
	public class ES3UserType_RoomLevelArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_RoomLevelArray() : base(typeof(RoomData.RoomLevel[]), ES3UserType_RoomLevel.Instance)
		{
			Instance = this;
		}
	}
