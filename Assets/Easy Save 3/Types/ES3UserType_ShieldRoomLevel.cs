...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("shieldRespawnTime", "shieldMaxAmount", "shieldReneratePerSecond", "roomName", "level", "roomType", "category", "hitPoint", "size", "cost", "crewRequirement", "powerRequirement", "damageHitPointRate", "roomSprite", "roomIconPrefab", "toolTipPrefab", "possibleDoorPositions", "crewEntryGridPriority")]
	public class ES3UserType_ShieldRoomLevel : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_ShieldRoomLevel() : base(typeof(ShieldRoomData.ShieldRoomLevel)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (ShieldRoomData.ShieldRoomLevel)obj;
			
			writer.WriteProperty("shieldRespawnTime", instance.shieldRespawnTime, ES3Type_float.Instance);
			writer.WriteProperty("shieldMaxAmount", instance.shieldMaxAmount, ES3Type_float.Instance);
			writer.WriteProperty("shieldReneratePerSecond", instance.shieldReneratePerSecond, ES3Type_float.Instance);
		...
		protected override void ReadObject<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "shieldRespawnTime":
						instance.shieldRespawnTime = reader.Read<System.Single>(ES3Type_float.Instance);
						break;
					case "shieldMaxAmount":
						instance.shieldMaxAmount = reader.Read<System.Single>(ES3Type_float.Instance);
						break;
					case "shieldReneratePerSecond":
						instance.shieldReneratePerSecond = reader.Read<System.Single>(ES3Type_float.Instance);
						break;
					case "roomName":
		...
		{
			var instance = new ShieldRoomData.ShieldRoomLevel();
	...
	public class ES3UserType_ShieldRoomLevelArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_ShieldRoomLevelArray() : base(typeof(ShieldRoomData.ShieldRoomLevel[]), ES3UserType_ShieldRoomLevel.Instance)
		{
			Instance = this;
		}
	}
