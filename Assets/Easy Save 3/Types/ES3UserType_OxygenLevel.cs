...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("oxygenSupplyPerSecond", "roomName", "level", "roomType", "category", "hitPoint", "size", "cost", "crewRequirement", "powerRequirement", "damageHitPointRate", "roomSprite", "roomIconPrefab", "toolTipPrefab", "possibleDoorPositions", "crewEntryGridPriority")]
	public class ES3UserType_OxygenLevel : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_OxygenLevel() : base(typeof(OxygenRoomData.OxygenLevel)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (OxygenRoomData.OxygenLevel)obj;
			
			writer.WriteProperty("oxygenSupplyPerSecond", instance.oxygenSupplyPerSecond, ES3Type_float.Instance);
		...
		protected override void ReadObject<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "oxygenSupplyPerSecond":
						instance.oxygenSupplyPerSecond = reader.Read<System.Single>(ES3Type_float.Instance);
						break;
					case "roomName":
		...
		{
			var instance = new OxygenRoomData.OxygenLevel();
	...
	public class ES3UserType_OxygenLevelArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_OxygenLevelArray() : base(typeof(OxygenRoomData.OxygenLevel[]), ES3UserType_OxygenLevel.Instance)
		{
			Instance = this;
		}
	}
