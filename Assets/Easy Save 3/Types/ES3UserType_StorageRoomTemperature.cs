...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("currentTemperature", "storedItems", "itemGrid", "currentRoomLevelData", "position", "currentLevel", "currentHitPoints", "roomType", "isDamageable", "connectedDoors", "currentRotation", "crewInRoom", "isActive", "isPowered", "isPowerRequested", "parentShip", "gridSize", "damageCondition", "roomData")]
