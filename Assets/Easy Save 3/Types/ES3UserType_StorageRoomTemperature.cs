...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("currentTemperature", "storedItems", "itemGrid", "currentRoomLevelData", "roomData", "position", "currentLevel", "currentHitPoints", "roomType", "isDamageable", "connectedDoors", "currentRotation", "crewInRoom", "isActive", "isPowered", "isPowerRequested", "roomRenderer", "parentShip", "icon", "gridSize", "damageCondition", "workDirection")]
	public class ES3UserType_StorageRoomTemperature : ES3ComponentType
	{
		public static ES3Type Instance = null;

		public ES3UserType_StorageRoomTemperature() : base(typeof(StorageRoomTemperature)){ Instance = this; priority = 1;}
		...
		protected override void ReadComponent<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					break;
					case "roomData":
					instance = (StorageRoomTemperature)reader.SetPrivateField("roomData", reader.Read<RoomData>(), instance);
					break;
					case "position":
						instance.position = reader.Read<UnityEngine.Vector2Int>(ES3Type_Vector2Int.Instance);
						break;
					case "currentLevel":
					instance = (StorageRoomTemperature)reader.SetPrivateField("currentLevel", reader.Read<System.Int32>(), instance);
					break;
					...
					case "roomType":
						...
						break;
					case "isDamageable":
					instance = (StorageRoomTemperature)reader.SetPrivateField("isDamageable", reader.Read<System.Boolean>(), instance);
					break;
					case "connectedDoors":
					instance = (StorageRoomTemperature)reader.SetPrivateField("connectedDoors", reader.Read<System.Collections.Generic.List<Door>>(), instance);
					break;
					...
					case "isActive":
						...
						break;
					case "isPowered":
					instance = (StorageRoomTemperature)reader.SetPrivateField("isPowered", reader.Read<System.Boolean>(), instance);
					break;
					case "isPowerRequested":
					instance = (StorageRoomTemperature)reader.SetPrivateField("isPowerRequested", reader.Read<System.Boolean>(), instance);
					break;
					case "roomRenderer":
					instance = (StorageRoomTemperature)reader.SetPrivateField("roomRenderer", reader.Read<UnityEngine.SpriteRenderer>(), instance);
					break;
					case "parentShip":
						instance.parentShip = reader.Read<Ship>(ES3UserType_Ship.Instance);
						break;
					case "icon":
					instance = (StorageRoomTemperature)reader.SetPrivateField("icon", reader.Read<UnityEngine.SpriteRenderer>(), instance);
					break;
					case "gridSize":
					instance = (StorageRoomTemperature)reader.SetPrivateField("gridSize", reader.Read<UnityEngine.Vector2Int>(), instance);
					break;
	...
	public class ES3UserType_StorageRoomTemperatureArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_StorageRoomTemperatureArray() : base(typeof(StorageRoomTemperature[]), ES3UserType_StorageRoomTemperature.Instance)
		{
			Instance = this;
		}
	}
