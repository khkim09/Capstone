...
namespace ES3Types
{
    ...
    [ES3PropertiesAttribute("currentTemperature", "storedItems", "itemGrid", "currentRoomLevelData", "position",
        "currentLevel", "currentHitPoints", "roomType", "isDamageable", "connectedDoors", "currentRotation",
        "crewInRoom", "isActive", "isPowered", "isPowerRequested", "parentShip", "gridSize", "damageCondition",
        "roomData")]
    public class ES3UserType_StorageRoomTemperature : ES3ComponentType
    {
        public static ES3Type Instance = null;

        public ES3UserType_StorageRoomTemperature() : base(typeof(StorageRoomTemperature))
        {
            Instance = this;
            priority = 1;
        }
        ...
        {
            StorageRoomTemperature instance = (StorageRoomTemperature)obj;
            ...
            foreach (string propertyName in reader.Properties)
                switch (propertyName)
                {
                    case "currentTemperature":
                        instance = (StorageRoomTemperature)reader.SetPrivateField("currentTemperature",
                            reader.Read<int>(), instance);
                        break;
                    case "storedItems":
                        instance.storedItems = reader.Read<System.Collections.Generic.List<TradingItem>>();
                        break;
                    case "itemGrid":
                        instance = (StorageRoomTemperature)reader.SetPrivateField("itemGrid",
                            reader.Read<TradingItem[,]>(), instance);
                        break;
                    case "currentRoomLevelData":
                        instance = (StorageRoomTemperature)reader.SetPrivateField("currentRoomLevelData",
                    ...
                    case "position":
                        ...
                        break;
                    case "currentLevel":
                        instance = (StorageRoomTemperature)reader.SetPrivateField("currentLevel", reader.Read<int>(),
                            instance);
                        break;
                    ...
                    case "roomType":
                        ...
                        break;
                    case "isDamageable":
                        instance = (StorageRoomTemperature)reader.SetPrivateField("isDamageable", reader.Read<bool>(),
                            instance);
                        break;
                    case "connectedDoors":
                        instance = (StorageRoomTemperature)reader.SetPrivateField("connectedDoors",
                    ...
                    case "isActive":
                        ...
                        break;
                    case "isPowered":
                        instance = (StorageRoomTemperature)reader.SetPrivateField("isPowered", reader.Read<bool>(),
                            instance);
                        break;
                    case "isPowerRequested":
                        instance = (StorageRoomTemperature)reader.SetPrivateField("isPowerRequested",
                            reader.Read<bool>(), instance);
                        break;
                    case "parentShip":
                        instance.parentShip = reader.Read<Ship>(ES3UserType_Ship.Instance);
                        break;
                    case "gridSize":
                        instance = (StorageRoomTemperature)reader.SetPrivateField("gridSize", reader.Read<Vector2Int>(),
                            instance);
                        break;
    ...
    public class ES3UserType_StorageRoomTemperatureArray : ES3ArrayType
    {
        ...
        public ES3UserType_StorageRoomTemperatureArray() : base(typeof(StorageRoomTemperature[]),
            ES3UserType_StorageRoomTemperature.Instance)
        {
            Instance = this;
        }
    }
