...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("crewMoraleBonus", "roomName", "level", "roomType", "category", "hitPoint", "size", "cost", "crewRequirement", "powerRequirement", "damageHitPointRate", "roomSprite", "roomIconPrefab", "toolTipPrefab", "possibleDoorPositions", "crewEntryGridPriority")]
	public class ES3UserType_LifeSupportRoomLevel : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_LifeSupportRoomLevel() : base(typeof(LifeSupportRoomData.LifeSupportRoomLevel)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (LifeSupportRoomData.LifeSupportRoomLevel)obj;
		...
		{
			var instance = new LifeSupportRoomData.LifeSupportRoomLevel();
	...
	public class ES3UserType_LifeSupportRoomLevelArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_LifeSupportRoomLevelArray() : base(typeof(LifeSupportRoomData.LifeSupportRoomLevel[]), ES3UserType_LifeSupportRoomLevel.Instance)
		{
			Instance = this;
		}
	}
