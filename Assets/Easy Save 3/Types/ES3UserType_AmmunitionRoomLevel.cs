...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("reloadTimeBonus", "damageBonus", "roomName", "level", "roomType", "category", "hitPoint", "size", "cost", "crewRequirement", "powerRequirement", "damageHitPointRate", "roomSprite", "roomIconPrefab", "toolTipPrefab", "possibleDoorPositions", "crewEntryGridPriority")]
	public class ES3UserType_AmmunitionRoomLevel : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_AmmunitionRoomLevel() : base(typeof(AmmunitionRoomData.AmmunitionRoomLevel)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (AmmunitionRoomData.AmmunitionRoomLevel)obj;
			
			writer.WriteProperty("reloadTimeBonus", instance.reloadTimeBonus, ES3Type_float.Instance);
			writer.WriteProperty("damageBonus", instance.damageBonus, ES3Type_float.Instance);
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "reloadTimeBonus":
						instance.reloadTimeBonus = reader.Read<System.Single>(ES3Type_float.Instance);
						break;
					case "damageBonus":
						instance.damageBonus = reader.Read<System.Single>(ES3Type_float.Instance);
						break;
					case "roomName":
		...
		{
			var instance = new AmmunitionRoomData.AmmunitionRoomLevel();
	...
	public class ES3UserType_AmmunitionRoomLevelArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_AmmunitionRoomLevelArray() : base(typeof(AmmunitionRoomData.AmmunitionRoomLevel[]), ES3UserType_AmmunitionRoomLevel.Instance)
		{
			Instance = this;
		}
	}
