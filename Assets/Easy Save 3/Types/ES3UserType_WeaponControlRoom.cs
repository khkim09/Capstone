...
namespace ES3Types
{
	...
	public class ES3UserType_WeaponControlRoom : ES3ComponentType
	{
		public static ES3Type Instance = null;

		public ES3UserType_WeaponControlRoom() : base(typeof(WeaponControlRoom)){ Instance = this; priority = 1;}


		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			var instance = (WeaponControlRoom)obj;
		...
		protected override void ReadComponent<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					instance = (WeaponControlRoom)reader.SetPrivateField("currentRoomLevelData", reader.Read<WeaponControlRoomData.WeaponControlRoomLevel>(), instance);
					break;
					case "roomData":
					instance = (WeaponControlRoom)reader.SetPrivateField("roomData", reader.Read<RoomData>(), instance);
					break;
					case "position":
						instance.position = reader.Read<UnityEngine.Vector2Int>(ES3Type_Vector2Int.Instance);
						break;
					case "currentLevel":
					instance = (WeaponControlRoom)reader.SetPrivateField("currentLevel", reader.Read<System.Int32>(), instance);
					break;
					...
					case "roomType":
						...
						break;
					case "isDamageable":
					instance = (WeaponControlRoom)reader.SetPrivateField("isDamageable", reader.Read<System.Boolean>(), instance);
					break;
					case "connectedDoors":
					instance = (WeaponControlRoom)reader.SetPrivateField("connectedDoors", reader.Read<System.Collections.Generic.List<Door>>(), instance);
					break;
					...
					case "isActive":
						...
						break;
					case "isPowered":
					instance = (WeaponControlRoom)reader.SetPrivateField("isPowered", reader.Read<System.Boolean>(), instance);
					break;
					case "isPowerRequested":
					instance = (WeaponControlRoom)reader.SetPrivateField("isPowerRequested", reader.Read<System.Boolean>(), instance);
					break;
					case "roomRenderer":
					instance = (WeaponControlRoom)reader.SetPrivateField("roomRenderer", reader.Read<UnityEngine.SpriteRenderer>(), instance);
					break;
					case "parentShip":
						instance.parentShip = reader.Read<Ship>(ES3UserType_Ship.Instance);
						break;
					case "icon":
					instance = (WeaponControlRoom)reader.SetPrivateField("icon", reader.Read<UnityEngine.SpriteRenderer>(), instance);
					break;
					case "gridSize":
					instance = (WeaponControlRoom)reader.SetPrivateField("gridSize", reader.Read<UnityEngine.Vector2Int>(), instance);
					break;
	...
	public class ES3UserType_WeaponControlRoomArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_WeaponControlRoomArray() : base(typeof(WeaponControlRoom[]), ES3UserType_WeaponControlRoom.Instance)
		{
			Instance = this;
		}
	}
