...
namespace ES3Types
{
    ...
    public class ES3UserType_WeaponControlRoom : ES3ComponentType
    {
        ...
        public ES3UserType_WeaponControlRoom() : base(typeof(WeaponControlRoom))
        {
            Instance = this;
            priority = 1;
        }
        ...
        {
            WeaponControlRoom instance = (WeaponControlRoom)obj;
            ...
            foreach (string propertyName in reader.Properties)
                switch (propertyName)
                {
                    case "currentRoomLevelData":
                        instance = (WeaponControlRoom)reader.SetPrivateField("currentRoomLevelData",
                            reader.Read<WeaponControlRoomData.WeaponControlRoomLevel>(), instance);
                        break;
                    case "position":
                        instance.position = reader.Read<Vector2Int>(ES3Type_Vector2Int.Instance);
                        break;
                    case "currentLevel":
                        instance = (WeaponControlRoom)reader.SetPrivateField("currentLevel", reader.Read<int>(),
                            instance);
                        break;
                    ...
                    case "roomType":
                        ...
                        break;
                    case "isDamageable":
                        instance = (WeaponControlRoom)reader.SetPrivateField("isDamageable", reader.Read<bool>(),
                            instance);
                        break;
                    case "connectedDoors":
                        instance = (WeaponControlRoom)reader.SetPrivateField("connectedDoors",
                    ...
                    case "isActive":
                        ...
                        break;
                    case "isPowered":
                        instance = (WeaponControlRoom)reader.SetPrivateField("isPowered", reader.Read<bool>(),
                            instance);
                        break;
                    case "isPowerRequested":
                        instance = (WeaponControlRoom)reader.SetPrivateField("isPowerRequested", reader.Read<bool>(),
                            instance);
                        break;
                    case "parentShip":
                        ...
                        break;
                    case "gridSize":
                        instance = (WeaponControlRoom)reader.SetPrivateField("gridSize", reader.Read<Vector2Int>(),
                            instance);
                        break;
    ...
    public class ES3UserType_WeaponControlRoomArray : ES3ArrayType
    {
        ...
        public ES3UserType_WeaponControlRoomArray() : base(typeof(WeaponControlRoom[]),
            ES3UserType_WeaponControlRoom.Instance)
        {
            Instance = this;
        }
    }
