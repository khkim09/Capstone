			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "currentRotation":
						...
						break;
					case "isActive":
					instance = (OxygenRoom)reader.SetPrivateField("isActive", reader.Read<System.Boolean>(), instance);
					break;
					case "isPowered":
					...
					break;
					case "parentShip":
					instance = (OxygenRoom)reader.SetPrivateField("parentShip", reader.Read<Ship>(), instance);
					break;
					case "gridSize":
