...
namespace ES3Types
{
	...
	public class ES3UserType_OxygenRoom : ES3ComponentType
	{
		...
		public ES3UserType_OxygenRoom() : base(typeof(OxygenRoom)){ Instance = this; priority = 1;}


		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			var instance = (OxygenRoom)obj;
		...
		protected override void ReadComponent<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					instance = (OxygenRoom)reader.SetPrivateField("currentRoomLevelData", reader.Read<OxygenRoomData.OxygenLevel>(), instance);
					break;
					case "roomData":
					instance = (OxygenRoom)reader.SetPrivateField("roomData", reader.Read<RoomData>(), instance);
					break;
					case "position":
						instance.position = reader.Read<UnityEngine.Vector2Int>(ES3Type_Vector2Int.Instance);
						break;
					case "currentLevel":
					instance = (OxygenRoom)reader.SetPrivateField("currentLevel", reader.Read<System.Int32>(), instance);
					break;
					...
					case "roomType":
						...
						break;
					case "isDamageable":
					instance = (OxygenRoom)reader.SetPrivateField("isDamageable", reader.Read<System.Boolean>(), instance);
					break;
					case "connectedDoors":
					instance = (OxygenRoom)reader.SetPrivateField("connectedDoors", reader.Read<System.Collections.Generic.List<Door>>(), instance);
					break;
					...
					case "parentShip":
						...
						break;
					case "icon":
					instance = (OxygenRoom)reader.SetPrivateField("icon", reader.Read<UnityEngine.SpriteRenderer>(), instance);
					break;
					case "gridSize":
					instance = (OxygenRoom)reader.SetPrivateField("gridSize", reader.Read<UnityEngine.Vector2Int>(), instance);
					break;
