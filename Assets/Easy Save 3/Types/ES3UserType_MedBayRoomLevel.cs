...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("healPerSecond", "roomName", "level", "roomType", "category", "hitPoint", "size", "cost", "crewRequirement", "powerRequirement", "damageHitPointRate", "roomSprite", "roomIconPrefab", "toolTipPrefab", "possibleDoorPositions", "crewEntryGridPriority")]
	public class ES3UserType_MedBayRoomLevel : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_MedBayRoomLevel() : base(typeof(MedBayRoomData.MedBayRoomLevel)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (MedBayRoomData.MedBayRoomLevel)obj;
			
			writer.WriteProperty("healPerSecond", instance.healPerSecond, ES3Type_float.Instance);
		...
		protected override void ReadObject<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "healPerSecond":
						instance.healPerSecond = reader.Read<System.Single>(ES3Type_float.Instance);
						break;
					case "roomName":
		...
		{
			var instance = new MedBayRoomData.MedBayRoomLevel();
	...
	public class ES3UserType_MedBayRoomLevelArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_MedBayRoomLevelArray() : base(typeof(MedBayRoomData.MedBayRoomLevel[]), ES3UserType_MedBayRoomLevel.Instance)
		{
			Instance = this;
		}
	}
