...
namespace ES3Types
{
    ...
    public class ES3UserType_CorridorRoom : ES3ComponentType
    {
        ...
        public ES3UserType_CorridorRoom() : base(typeof(CorridorRoom))
        {
            Instance = this;
            priority = 1;
        }
        ...
        {
            CorridorRoom instance = (CorridorRoom)obj;
            ...
            foreach (string propertyName in reader.Properties)
                switch (propertyName)
                {
                    case "currentRoomLevelData":
                        instance = (CorridorRoom)reader.SetPrivateField("currentRoomLevelData",
                            reader.Read<CorridorRoomData.CorridorRoomLevel>(), instance);
                        break;
                    case "position":
                        instance.position = reader.Read<Vector2Int>(ES3Type_Vector2Int.Instance);
                        break;
                    case "currentLevel":
                        instance = (CorridorRoom)reader.SetPrivateField("currentLevel", reader.Read<int>(), instance);
                        break;
                    ...
                    case "roomType":
                        ...
                        break;
                    case "isDamageable":
                        instance = (CorridorRoom)reader.SetPrivateField("isDamageable", reader.Read<bool>(), instance);
                        break;
                    case "connectedDoors":
                        instance = (CorridorRoom)reader.SetPrivateField("connectedDoors",
                    ...
                    case "isActive":
                        ...
                        break;
                    case "isPowered":
                        instance = (CorridorRoom)reader.SetPrivateField("isPowered", reader.Read<bool>(), instance);
                        break;
                    case "isPowerRequested":
                        instance = (CorridorRoom)reader.SetPrivateField("isPowerRequested", reader.Read<bool>(),
                            instance);
                        break;
                    case "parentShip":
                        ...
                        break;
                    case "gridSize":
                        instance = (CorridorRoom)reader.SetPrivateField("gridSize", reader.Read<Vector2Int>(),
                            instance);
                        break;
