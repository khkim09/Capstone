...
namespace ES3Types
{
	...
	[ES3PropertiesAttribute("teleportWaitingTime", "teleportRespawnTime", "roomName", "level", "roomType", "category", "hitPoint", "size", "cost", "crewRequirement", "powerRequirement", "damageHitPointRate", "roomSprite", "roomIconPrefab", "toolTipPrefab", "possibleDoorPositions", "crewEntryGridPriority")]
	public class ES3UserType_TeleportRoomLevel : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_TeleportRoomLevel() : base(typeof(TeleportRoomData.TeleportRoomLevel)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (TeleportRoomData.TeleportRoomLevel)obj;
			
			writer.WriteProperty("teleportWaitingTime", instance.teleportWaitingTime, ES3Type_float.Instance);
			writer.WriteProperty("teleportRespawnTime", instance.teleportRespawnTime, ES3Type_float.Instance);
		...
		protected override void ReadObject<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "teleportWaitingTime":
						instance.teleportWaitingTime = reader.Read<System.Single>(ES3Type_float.Instance);
						break;
					case "teleportRespawnTime":
						instance.teleportRespawnTime = reader.Read<System.Single>(ES3Type_float.Instance);
						break;
					case "roomName":
		...
		{
			var instance = new TeleportRoomData.TeleportRoomLevel();
	...
	public class ES3UserType_TeleportRoomLevelArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_TeleportRoomLevelArray() : base(typeof(TeleportRoomData.TeleportRoomLevel[]), ES3UserType_TeleportRoomLevel.Instance)
		{
			Instance = this;
		}
	}
