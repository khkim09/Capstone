...
namespace ES3Types
{
    ...
    public class ES3UserType_CockpitRoom : ES3ComponentType
    {
        ...
        public ES3UserType_CockpitRoom() : base(typeof(CockpitRoom))
        {
            Instance = this;
            priority = 1;
        }
        ...
        {
            CockpitRoom instance = (CockpitRoom)obj;
            ...
            foreach (string propertyName in reader.Properties)
                switch (propertyName)
                {
                    case "currentRoomLevelData":
                        instance = (CockpitRoom)reader.SetPrivateField("currentRoomLevelData",
                            reader.Read<CockpitRoomData.CockpitRoomLevel>(), instance);
                        break;
                    case "position":
                        instance.position = reader.Read<Vector2Int>(ES3Type_Vector2Int.Instance);
                        break;
                    case "currentLevel":
                        instance = (CockpitRoom)reader.SetPrivateField("currentLevel", reader.Read<int>(), instance);
                        break;
                    ...
                    case "roomType":
                        ...
                        break;
                    case "isDamageable":
                        instance = (CockpitRoom)reader.SetPrivateField("isDamageable", reader.Read<bool>(), instance);
                        break;
                    case "connectedDoors":
                        instance = (CockpitRoom)reader.SetPrivateField("connectedDoors",
                    ...
                    case "isActive":
                        ...
                        break;
                    case "isPowered":
                        instance = (CockpitRoom)reader.SetPrivateField("isPowered", reader.Read<bool>(), instance);
                        break;
                    case "isPowerRequested":
                        instance = (CockpitRoom)reader.SetPrivateField("isPowerRequested", reader.Read<bool>(),
                            instance);
                        break;
                    case "parentShip":
                        ...
                        break;
                    case "gridSize":
                        instance = (CockpitRoom)reader.SetPrivateField("gridSize", reader.Read<Vector2Int>(), instance);
                        break;
                    case "damageCondition":
                        instance.damageCondition = reader.Read<DamageLevel>();
                        break;
                    case "roomData":
                        instance.roomData = reader.Read<CockpitRoomData>();
                        break;
                    default:
                        reader.Skip();
                        break;
