			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "currentRotation":
						...
						break;
					case "isActive":
					instance = (CockpitRoom)reader.SetPrivateField("isActive", reader.Read<System.Boolean>(), instance);
					break;
					case "isPowered":
					...
					break;
					case "parentShip":
					instance = (CockpitRoom)reader.SetPrivateField("parentShip", reader.Read<Ship>(), instance);
					break;
					case "gridSize":
